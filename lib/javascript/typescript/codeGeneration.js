...
class TypescriptAPIGenerator extends language_1.default {
    ...
    handleFieldSelectionSetValue(generatedTypeAnnotation, field) {
        ...
        if (variants.length === 1) {
            ...
            exportedTypeAlias = this.exportDeclaration(this.typeAliasObjectUnion(generatedTypeAnnotation.id.name, propertySets));
        }
        this.printer.enqueue(exportedTypeAlias);
        return {
            name: field.alias ? field.alias : field.name,
            description: field.description,
            annotation: field.type instanceof graphql_1.GraphQLNonNull
