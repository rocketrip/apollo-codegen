...
class FlowAPIGenerator extends language_1.default {
    ...
    handleFieldSelectionSetValue(generatedTypeName, field) {
        ...
        const selectionValueGeneratedTypeName = field.type instanceof graphql_1.GraphQLNonNull
        ...
        return {
            ...
            annotation: t.genericTypeAnnotation(t.identifier(selectionValueGeneratedTypeName))
        };
    }
